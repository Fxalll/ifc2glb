...
(本项目已经发表相关论文及获得发明专利；核心代码已隐藏，本仓库只作为使用文档展示。)
...
| 项目模型 | 属性       | 转换前  | 转换后  | 压缩后  | 压缩率 |
|----------|------------|---------|---------|---------|--------|
| 项目模型A | 构件数/个   | 7838    | 7838    | 7838    | -      |
|          | 大小/MB    | 41.6    | 13.8    | 5.5     | 87%    |
| 项目模型B | 构件数/个   | 75846   | 75846   | 25846   | -      |
|          | 大小/MB    | 106.5   | 30.7    | 12.3    | 88%    |
| 项目模型C | 构件数/个   | 179787  | 179787  | 179787  | -      |
|          | 大小/MB    | 251.7   | 70.3    | 28.2    | 88%    |
